...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function nextPage(){
				...
				var form = document.getElementById("listMyRepairForm");
				form.submit();
			}
	...
	<body>
		<form action="listMyRepair" method="post" id="listMyRepairForm">
			<!-- 用隐藏域保存用户选择的页数 -->
			...
			<table border="1" width="98%" align="center" cellpadding="0"
				...
				<tr>
					...
					<td>
						...
						<img
							onMouseUp="toggleDateTimePicker('daysOfMonth','listMyRepairForm.transportDateStart',false)"
					...
					<td>
						...
						<img
							onMouseUp="toggleDateTimePicker('daysOfMonth1','listMyRepairForm.transportDateEnd',false)"
				...
				<tr>
					<td height="22" align="left" bgcolor="#8DB6CD">
						<a href="#" style="margin-right:5px;" class="lessline gray"
							onClick="completeRepair()"><img
								src="${pageContext.request.contextPath}/images/extico/gout.gif"
								width="16" height="16" align="absmiddle">维修过程</a>
					</td>
					
					<td height="22" align="left" bgcolor="#8DB6CD">
						<a href="#" style="margin-right:5px;" class="lessline gray"
							onClick="addOtherRepair()"><img
								src="${pageContext.request.contextPath}/images/extico/add.gif"
								width="16" height="16" align="absmiddle">添加其它维修</a>
					</td>
					
					<td height="22" align="left" bgcolor="#8DB6CD">
						<a href="#" style="margin-right:5px;" class="lessline gray"
							onClick="giveupRepair()"><img
								src="${pageContext.request.contextPath}/images/extico/add.gif"
								width="16" height="16" align="absmiddle">转出维修</a>
					</td>
				</tr>
			</table>
			<!--功能区结束-->
