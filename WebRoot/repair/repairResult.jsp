...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function nextPage(){
				...
				var form = document.getElementById("listRepairResultForm");
				form.submit();
			}
			...
			function returnDevice(){
				if(getCheckboxCount()==0){
					...
					//alert('a');
					var form = document.getElementById("listRepairResultForm");
					form.action="returnDeviceToOfficesView";
					form.submit();
	...
	<body>
		<form action="listRepairResult" method="post" id="listRepairResultForm">
			<!-- 用隐藏域保存用户选择的页数 -->
			...
			<table border="1" width="98%" align="center" cellpadding="0"
				...
				<tr>
					...
					<td>
						...
						<img
							onMouseUp="toggleDateTimePicker('daysOfMonth','listRepairResultForm.transportDateStart',false)"
					...
					<td>
						...
						<img
							onMouseUp="toggleDateTimePicker('daysOfMonth1','listRepairResultForm.transportDateEnd',false)"
				...
				<tr>
					<td height="22" align="left" bgcolor="#8DB6CD">
						<a href="#" style="margin-right:5px;" class="lessline gray"
							onClick="returnDevice()"><img
								src="${pageContext.request.contextPath}/images/extico/onoff.gif"
								width="16" height="16" align="absmiddle">科室取回设备</a>
					</td>
				</tr>
			</table>
			<!--功能区结束-->
					...
					<s:iterator value="repairs">
						<tr>
							...
							<td>
								&nbsp;
								<!-- <s:property value="status" /> -->
								<s:property value="returnFlagString" />
							</td>
						</tr>
					</s:iterator>
				</table>
